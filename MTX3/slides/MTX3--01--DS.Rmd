...
subtitle: "Medidas de dependencia serial y estacionariedad"
author: 
...
<a class="pdf-footer" href="MTX3--01--DS.pdf" target="_blank">
  PDF
</a>
...
## Estacionariedad estricta y ergodicidad
...
Usualmente, _estacionariedad débil_ no implica estacionariedad fuerte y viceversa.
...
$$
\begin{align}
\lim_{T\rightarrow\infty} \frac{1}{T}\sum_{t=1}^T y_t &= \mathbb{E}(y_t) \\
& = \mu
\end{align}
$$


Se puede demostrar que una _condición necesaria_ para la ergodicidad es que:

$$
\sum_{j=0}^{\infty} |\gamma_y(j)|<\infty.
$$

Además, esta _condición es suficiente_ si \(y_t \sim iid\mathcal{N}(\cdot)\).
...
Se puede demostrar que, si \(y_t \sim iid\mathcal{N}(\cdot)\), _una serie de tiempo es ergódica en covarianza si es ergódica en su media_.